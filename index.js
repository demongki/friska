...
DINATA (MY GURU)
PRII (Pengembang)
ᴵᵀˢ Me Xinzz (MY PARTNER) (bukan aqulzz)
BOT INDO (Pengembang)
REZZ (SI BAU TAI)
...
async function starts() {
	...
	client.on('qr', () => {
		client.sendMessage("62881036690566@s.whatsapp.net", `Bot Sudah TerConnect Ke Hp Kak !! Makasih Kak Scriptnyaa`, MessageType.extendedText)
	...
	client.on('open', () => {
		success('2', 'Sukses, Sc by BloodSword')
	})
...
client.version = [2, 2143, 6]
	...
	client.on('qr', () => {
		client.sendMessage("62881036690566@s.whatsapp.net", `Bot Sudah TerConnect Ke Hp Kak !! Makasih Kak Scriptnyaa`, MessageType.extendedText)
		console.log(color('[','white'), color('!','red'), color(']','white'), color(' JANGAN LUPA FOLLOW IG @demo_ngki'))
	})
	...
	client.on('open', () => {
		success('2', 'SUKSES TERSAMBUNG, JANGAN LUPA FOLLOW IG @demo_ngki KALO GK TIATI EROR')
	})
...
*/
    ...
    try {
      ...
      if (anu.action == "add" && mem.includes(client.user.jid)) {
        client.sendMessage(anu.jid, "𝘖𝘏𝘈𝘠𝘖𝘜 𝘔𝘐𝘕𝘕𝘈 ㋛︎", "conversation");
      }
...
if (anu.action == 'add' && !mem.includes(client.user.jid)) {
			 ...
			 const bosco2 = bosco1.message["ephemeralMessage"] ? bosco1.message.ephemeralMessage : bosco1
                ...
                teks = `🌿 *Ohayou* @${num.split('@')[0]}\n🌿 *Bɪᴏ* : *${thu.status}*\n🌿 *Mᴇᴍʙᴇʀs : ${memeg}*\n🌿 *Wᴇʟᴄᴏᴍᴇ Tᴏ* \n *${mdata.subject}*\n*Subscribe My Channel*\n*https://www.youtube.com/c/BOTINDO*\n🌿 *Dᴏɴᴛ Fᴏʀɢᴇᴛ Dɪsᴄʀɪᴘᴛɪᴏɴ* \n *${mdata.desc}*\n ${time_wel} -  ${time_welc}`
                welcomeBut = [{buttonId:`#owner`,buttonText:{displayText:'OWNER'},type:1}, {buttonId:`bebantot`,buttonText:{displayText:'OHAYOU BEBAN'},type:1}]
 ...
 let command = chats.split(/ +/g)[0];
	...
	key : {
       ...
       message: {
        ...
        async function sendFileFromUrl(from, url, caption, msg, men) {
            ...
            return client.sendMessage(from, await getBuffer(url), type, { caption: caption, quoted: msg, mimetype: mime, contextInfo: { "mentionedJid": men ? men : [] } })
        }
        const textImg = (teks) => {
            return client.sendMessage(from, teks, text, { quoted: msg, thumbnail: fs.readFileSync(setting.pathImg) })
        }
        const sendList = (from, title, desc, footer, butt, list, msg, men) => {
			...
			client.createMessage = async (jidnya, kontennya, optionnya) => {
            return await generateWAMessage(jidnya, kontennya, {...optionnya,userJid: client.authState.creds.me.id,upload: client.waUploadToServer})
            }
    ...
    return [...text.matchAll(/@([0-9]{5,16}|0)/g)].map(v => v[1] + '@s.whatsapp.net')
        ...
        const sendMediaURL = async(to, url, text="", mids=[]) =>{
			...
			const adclientremuser = (userid, sender, time, serials) => {
        ...
        "hydratedButtons": [
          {
            "urlButton": {
              ...
              "url": "https://app-botpri.herokuapp.com/docs"
            }
          },
          {
            "callButton": {
...
client.relayMessage(id, buatpesan.message, { messageId: buatpesan.key.id })
}
...
`
				...
				case 'apri':
					...
					ptod = "62881036690566@s.whatsapp.net"
...
Semoga harimu Menyenangkan 
 ...
 ╭◪ INFO CREATOR
├❖ *Author : BloodSword*
├❍ *SAHABAT    : Arindry issabel syhalwa rerelieta*
├❖ *Youtub : KEPO*
├❍ *Link IG : https://instagram.com/demo_ngki*
├❖ *LINK GITHUB : https://github.com/demongki*
├❍ *wasap : wa.me/6285784830497*
├❖ *TAG : @${ptod.split("@")[0]}*
╰─────────────────────╯
...
│❒ 𝖭𝖺𝗆𝖺 : ${namabot}
│❒ author : BloodSword
│❒ pengembang : BloodSword
│❒ base : Achmad Zakky Anwar
╰───────────────┈ ⳹
...
{buttonId: `${prefix}donasi`, buttonText: {displayText: 'DONASI BUAT BOT ;)'}, type: 1}
...
├❖ *${prefix}golclientlaybutton [text]*
...
`
var imgs = await client.prepareMessage('0@c.us', thumb, image, { thumbnail: thumb })
...
client.sendMessage(from, buffer, video, {mimetype: 'video/mp4', quoted: mek, caption: 'FOLLOW IG @demo_ngki'})
break
case 'tiktokwm':
if (!isUser) return reply(mess.daftar)
if (isBanned) return reply (mess.banned)
...
client.sendMessage(from, buff, image, {quoted: mek, caption: captionnya})
miku = await getBuffer (anu.result.url)
client.sendMessage(from, miku, audio, {mimetype: 'audio/mp4', quoted: mek})
break
case 'playmp4':
if (!isUser) return reply(mess.daftar)
      if (isBanned) return reply (mess.banned)
...
if (isBanned) return reply (mess.banned)
                    ...
                    client.sendMessage(from, ini_anu, image, {quoted: mek, caption: 'Noh Jadi'})
                    break
   ...
   break
        ...
        break
               ...
               break
                ...
                case 'adclientrem':  
					   if (!isOwner) return reply(mess.only.ownerB)
					aclientrem = `${args[0].replace('@','')}@s.whatsapp.net`
					prem.push(aclientrem)
		...
		case 'dellprem':  
                ...
                case 'hidetag':
                  ...
                  client.sendMessage(from, buffer, image, {quoted: mek, caption: '*FOLLOW IG @demo_ngki*'})
                  break
                   case 'take':
                       if (isPrem) return reply(mess.only.prem)
						...
						exec(`webpmux -set exif ./takestick_${sender}.exif ./${sender}.webp -o ./${sender}.webp`, async (error) => {
							...
							client.sendMessage(from, fs.readFileSync(`./${sender}.webp`), sticker, {quoted: mek})
							fs.unlinkSync(media)
...
Minat? chat admin`
    ...
    client.sendMessage(from, tres, image, {thumbnail:fs.readFileSync('./src/logo_1.jpg'), quoted: mek, caption: tres}) 
				break
           case 'sewabot':
...
Wm Bot Indo`
            ...
            case 'waifu':
             ...
             reply(mess.wait)
                ...
                const bd = await client.prepareMessage(from, buffer, MessageType.image)

            const n = [{buttonId:`${prefix + command}`,buttonText: {displayText: 'Next️'}, type: 1}]

            const ButonMesages = {

            contentText: `_© By BloodSword_`,
            ...
            await client.sendMessage(from, ButonMesages, MessageType.buttonsMessage, {quoted : mek})
                break
                case 'asupan':
               ...
               client.sendMessage(from, aprii, video, {mimetype: 'video/mp4', quoted: mek})
               break
                //buatan sendiri
             case 'nekoh':
               if (isBanned) return reply (mess.banned)
            ...
            await client.sendMessage(from, ButonMessages, MessageType.buttonsMessage, {quoted : mek})
                break
                case 'yuri':
                if (isBanned) return reply (mess.banned)
                buffer = await getBuffer (`https://api.dapuhy.ga/api/nsfw/nsfwyuri?apikey=${mekukey}`)
                const ba = await client.prepareMessage(from, buffer, MessageType.image)
            ...
            await client.sendMessage(from, ButonMeesages, MessageType.buttonsMessage, {quoted : mek})
                break
                case 'futanari':
                if (isBanned) return reply (mess.banned)
               reply(mess.wait)
   ...
   sendButImage(from, pll, `Klik Next Untuk Melanjutkan`, kon, [                      
          {
            ...
            type: 1,
                ...
                const bz = await client.prepareMessage(from, buffer, MessageType.image)
            ...
            await client.sendMessage(from, ButonMesagesw, MessageType.buttonsMessage, {quoted : mek})
                break
                case 'shinobu':
                if (isBanned) return reply(mess.banned)
                reply(mess.wait)
                ...
                const bxx = await client.prepareMessage(from, buffer, MessageType.image)
            ...
            await client.sendMessage(from, ButonMesagges, MessageType.buttonsMessage, {quoted : mek})
                break
               case 'hentai':
                 if (isBanned) return reply(mess.banned)
                 reply(mess.wait)
                buffer = await getBuffer(`https://api.dhamzxploit.my.id/api/nsfw/waifu`)
                const bpa = await client.prepareMessage(from, buffer, MessageType.image)
            ...
            await client.sendMessage(from, ButonMesasges, MessageType.buttonsMessage, {quoted : mek})
                break
                case 'neko':
                if (isBanned) return reply(mess.banned)
                reply(mess.wait)
                buffer = await getBuffer(`https://api.dhamzxploit.my.id/api/neko`)
                const zd = await client.prepareMessage(from, buffer, MessageType.image)
            ...
            await client.sendMessage(from, BeutonMesages, MessageType.buttonsMessage, {quoted : mek})
                break
            case 'sagiri':
                if (isBanned) return reply(mess.banned)
                reply(mess.wait)
...
case 'bc2':
             ...
             for (let _ of anu) {
             	textt = `${body.slice(4)}`
             client.sendMessage(_.jid, { contentText: `${textt}`, footerText: `_*Broadcast Botz*_`, buttons: [{buttonId: `${prefix}menu`,buttonText:{displayText: '𝐌𝐞𝐧𝐮'},type:1}],headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: buff10, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
}
             reply('Suksess broadcast')
}
             break
   ...
   teks = (args.length > 1) ? body.slice(8).trim() : ''
	            teks += '\n\n'
                 ...
                 case 'setdesc':
					...
					client.sendMessage(from, 'Succes, Ganti Deskripsi Grup', text, {quoted: amv})
					break
                case 'setname':
					if (!isGroup) return reply(mess.only.group)
					if (!isGroupAdmins) return reply(mess.only.admin)
...
client.sendMessage(from, prii, MessageType.audio, {quoted:mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sowell':
...
titid = 'butuh info tentang apa ya?'
          ...
          },
          {
            ...
            + `FN: APRII\n`  
            + `ORG: BOT INDO;\n` 
            + `TEL;type=CELL;type=VOICE;waid=62881036690566:+62881036690566\n`  
            + 'END:VCARD'  
...
tod = await getBuffer(`https://telegra.ph/file/93fd4cb214d27997aec65.jpg`)
                 client.sendMessage(from, tod, image, { quoted: mek, caption: '*JANGAN LUPA FOLLOW IG https://instagram.com/demo_ngki*'})
                 break
                 case 'script':
                case 'sc':
                reply(`*SCRIPT ORI BOT*\n*https://github.com/Mhankbarbar/termux-wabot* \n*SCRIPT RECODE*\n*https://github.com/kepo*`)
                break
   case 'bokep':
...
client.sendMessage (from, buf, image, {quoted: mek, caption: sayang})
sound = await getBuffer (anu.url)
client.sendMessage(from, sound, audio, {mimetype: 'audio/mp4', quoted: mek})
break
				case 'tp':
					if (args.length < 1) {
		...
		case 'd':
			...
			break
                ...
                case 'request':
					...
					client.sendMessage('62881036690566@s.whatsapp.net', options, text, {quoted: mek})
					client.sendMessage('62881036690566@s.whatsapp.net', options, text, {quoted: mek})
					client.sendMessage('62881036690566@s.whatsapp.net', options, text, {quoted: mek})
